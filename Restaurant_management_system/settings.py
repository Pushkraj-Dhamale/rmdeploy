...
CSRF_TRUSTED_ORIGINS= ['https://bharaticafe.up.railway.app/','https://untidy-railway-production.up.railway.app/']
ALLOWED_HOSTS = ['*']
CORS_ORIGIN_WHITELIST = ['https://bharaticafe.up.railway.app/','https://untidy-railway-production.up.railway.app/']
